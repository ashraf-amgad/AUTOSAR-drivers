...
/* AUTOSAR Version checking between CAN_PBcfg.c and CAN.h files */
#if  ( (CAN_PBCFG_AR_RELEASE_MAJOR_VERSION != CAN_CFG_AR_RELEASE_MAJOR_VERSION)\
    || (CAN_PBCFG_AR_RELEASE_MINOR_VERSION != CAN_CFG_AR_RELEASE_MINOR_VERSION)\
    || (CAN_PBCFG_AR_RELEASE_PATCH_VERSION != CAN_CFG_AR_RELEASE_PATCH_VERSION) )
#error "The AR version of Can_PBcfg.h does not match the expected version"
#endif
...
/* Software Version checking between CAN_PBcfg.c and CAN.h files */
#if  ( (CAN_PBCFG_SW_MAJOR_VERSION != CAN_CFG_SW_MAJOR_VERSION)\
    || (CAN_PBCFG_SW_MINOR_VERSION != CAN_CFG_SW_MINOR_VERSION)\
    || (CAN_PBCFG_SW_PATCH_VERSION != CAN_CFG_SW_PATCH_VERSION) )
#error "The SW version of Can_PBcfg.h does not match the expected version"
#endif
...
const Can_ConfigType Can_Configrations =
{
	...
	CAN_CONTROLLER_BAUDRATE_750_Khz , CAN_CONTROLLER_BAUDRATE_750_Khz_PROPSEG , CAN_CONTROLLER_BAUDRATE_750_Khz_SEG1 , CAN_CONTROLLER_BAUDRATE_750_Khz_SEG2 , CAN_CONTROLLER_BAUDRATE_750_Khz_SJW , 
